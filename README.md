...
Hola. Esto es el tema `samat`, para Ingeniería Samat S.L., está basado en el starter theme Underscores.
...
`samat` solo requiere estas dependencias:
...
Clona o descarga este repositorio `$ git clone https://github.com/alvarorubioc/samat` en tu carpeta de themes.

### Setup

Para empezar a usar todas las herramientas del tema `samat` necesitas instalar las dependencias de Node.js y Composer :
...
`samat` está preparado para el desarollo de la plantilla para WordPress :
